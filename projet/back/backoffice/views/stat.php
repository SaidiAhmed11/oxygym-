...
font-size: 16px;">  &nbsp; <a href="./logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
				...
				<li class="text-center">
                    ...
                    <li>
                        ...
                        <a  class="active-menu" href="commandeetpanier.php"><i class="fa fa-bar-chart-o fa-3x"></i> Commandes & Panier </a>
                           ...
                           <li>
                                <a href="afficherPaiement.php">Gérer les paiement</a>
    ...
    <?php  
 $connect = mysqli_connect("localhost", "root", "", "oxygym++");  
 $query = "SELECT pays, count(*) as number FROM paiement GROUP BY pays";  
