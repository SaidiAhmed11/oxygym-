    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="back.php">Oxygen ++</a> 
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class="active-menu"  href="back.php"><i class="fa fa-dashboard fa-3x"></i> Inscription </a>
                    </li>
                     <li>
                    ...
                    <li>
                        <a  href="produits.html"><i class="fa fa-qrcode fa-3x"></i> Produits </a>
						   ...
						   <li  >
                        <a   href="commandeetpanier.php"><i class="fa fa-bar-chart-o fa-3x"></i> Commandes & Panier </a>
                    </li>	
                      <li  >
