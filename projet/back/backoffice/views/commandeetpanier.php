                        ...
                        <a  class="active-menu" href="commandeetpanier.php"><i class="fa fa-bar-chart-o fa-3x"></i> Commandes & Panier </a>
                            ...
                            <li>
                                <a href="afficherPaiement.php">Gérer les Paiements</a>
                                   ...
                                   <li>
                                <a href="stat.php">Stat Paiments</a>
                            </li>
                               </ul>
                    </li>	
                      <li  >
                 ...
                 <hr />
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <form method="POST" action="afficherPaiement.php">
                                 <button type="submit" name="afficher" value="afficher"class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">
