...
<tr>
<td>Nom :</td>
<td><input type="text" name="nom" placeholder="Entrer Votre nom" value="<?PHP echo $nom?>"></td>
</tr>
<tr>
<td>Prenom :</td>
<td><input type="text" name="prenom" placeholder="Entrer Votre prenom" value="<?PHP echo $prenom?>"></td>
</tr>
<tr>
<td>E-Mail :</td>
<td> <input type="email" name="email"  placeholder="Nom.Prenom@gmail.com" value="<?PHP echo $mail?>"></td>
</tr>
     ...
     <tr> 
                 ...
                 <tr>
                  <td>
                       <input type="radio" name="type_paiement" value="visa" required> 
                   </td>
                        <td>
     ...
     <tr>
      ...
      <tr> 
                   ...
                   <td>
                       <input type="text" name="num_carte" placeholder="Exp: 6562 7452 7520 74 8" value="<?PHP echo $num_carte ?>" required> 
                   </td>
                </tr>
     <tr> 
                   <td> 
                   ...
                   <td>
                       <input type="date" name="date_exp" value="<?PHP echo $date_exp ?>" required> 
                   </td>
                </tr>
    <tr> 
                   <td> 
                   ...
                   <td>
                       <input type="password" name="Code_sec"  minlength="4" maxlength="4" placeholder="Exp: 1234" oncopy="return false" onpaste="return false" oncut="return false" value="<?PHP echo $Code_sec ?>" required > 
                   </td>
                </tr>
                   ...
                   <td>
                       <input type="text" name="code_postal" value="<?PHP echo $code_postal?>" required> 
                   </td>
                </tr>
                                              <tr> 
                   <td> 
                   ...
                   <td>
                       <input type="text" name="num_tel" value="<?PHP echo $num_tel?>" required> 
                   </td>
                </tr>             
