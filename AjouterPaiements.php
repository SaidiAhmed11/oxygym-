...
{ 
 ...
 <fieldset>
			<div > 
                ...
                <br> 
                <br> 
               <center> <p style="text-align: center"> Payer par Carte ou Se Connecter </p> </center>
   
                
                <table style="margin-top: 15px;">
                    <tr>
                        <td><label> Nom : </label> </td> 
                        <td> <input type="text" name="nom" id="nom" placeholder="Entrer Votre nom"  onblur="verifNom(this)" class="form-control flex-fill mr-0 mr-sm-2 mb-3 mb-sm-0" required> </td>
                    </tr>
               <tr> 
                   <td> 
                       <label> Prenom : </label>
     ...
     <div style="margin-left:20%">
				 <input class="btn btn-1" type="submit" name="ajouter" value="ajouter" class="btn btn-primary mx-auto" Onclick="test()" />
				 <input class="btn btn-1"  type="reset" class="btn btn-primary mx-auto" value="Reset" />
				</div>
  ...
  load_unseen_notification();; 
    ...
    <section id="panier" class="about-section text-center">
     <div id="col-main" >
            ...
            <form name="carteform" action="ajouterCommande.php" method="post" id="cartform" class="clearfix">
              <div class="row-fluid">
